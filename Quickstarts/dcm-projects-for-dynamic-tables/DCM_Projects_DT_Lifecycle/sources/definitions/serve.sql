...
FROM DCM_DEMO_1{{env_suffix}}.ANALYTICS.ENRICHED_ORDER_DETAILS
GROUP BY SALE_DATE
ORDER BY SALE_DATE;
...
FROM DCM_DEMO_1{{env_suffix}}.ANALYTICS.CUSTOMER_SPENDING_SUMMARY;
...
WITH customer_order_dates AS (
    SELECT
        ...
        e.LINE_ITEM_REVENUE
    FROM DCM_DEMO_1{{env_suffix}}.ANALYTICS.ENRICHED_ORDER_DETAILS e
    JOIN DCM_DEMO_1{{env_suffix}}.ANALYTICS.CUSTOMER_SPENDING_SUMMARY s
