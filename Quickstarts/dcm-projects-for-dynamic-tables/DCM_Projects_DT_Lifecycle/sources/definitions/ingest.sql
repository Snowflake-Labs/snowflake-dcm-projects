...
AS
BEGIN
    COPY INTO DCM_DEMO_1{{env_suffix}}.RAW.DAILY_ORDERS_INCOMING
    FROM @DCM_DEMO_1{{env_suffix}}.RAW.TASTY_BYTES_ORDERS_STAGE
    FILE_FORMAT = (
        TYPE = 'CSV',
        FIELD_DELIMITER = ',',
        SKIP_HEADER = 1,
    ...
    WHERE NOT EXISTS (
        SELECT 1
        FROM DCM_DEMO_1{{env_suffix}}.RAW.ORDER_HEADER dest
